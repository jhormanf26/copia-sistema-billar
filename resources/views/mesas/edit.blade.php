...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        <h1 class="m-0 text-dark">
            <i class="fas fa-edit text-primary"></i> Editar Mesa #{{ $mesa->numeromesa }}
        </h1>
            ...
            <div class="card card-info shadow-sm mb-3">
                <div class="card-body p-3">
                    ...
                    <small class="text-muted">
                        Modifique los campos necesarios para actualizar la mesa. Todos los campos con <span class="text-danger">*</span> son obligatorios.
                    </small>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline shadow-lg">
                <div class="card-header bg-gradient-primary">
                    <h3 class="card-title font-weight-bold">
                        <i class="fas fa-table"></i> Formulario de Edición de Mesa
                    </h3>
                ...
                <form action="{{ route('mesas.update', $mesa->idmesa) }}" method="POST" id="formEditarMesa">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" id="numeromesa" name="numeromesa"
                                ...
                                value="{{ old('numeromesa', $mesa->numeromesa) }}" required maxlength="10">
                            @error('numeromesa')
                        ...
                        <div class="form-group">
                            ...
                            <select id="tipo" name="tipo" class="form-control @error('tipo') is-invalid @enderror" required>
                                ...
                                <option value="tresbandas" {{ old('tipo', $mesa->tipo) == 'tresbandas' ? 'selected' : '' }}>Tres Bandas</option>
                                <option value="libre" {{ old('tipo', $mesa->tipo) == 'libre' ? 'selected' : '' }}>Libre</option>
                    ...
                    <div class="card-footer bg-light d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <button type="submit" id="btnActualizar" class="btn btn-primary shadow-sm ml-2">
...
<script>
    $('#formEditarMesa').on('submit', function(e){
        ...
        Swal.fire({
            ...
            html: `Está a punto de actualizar la mesa:<br><strong>"${$('#numeromesa').val()}"</strong>`,
            icon: 'question',
